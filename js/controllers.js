angular.module('starter.controllers', ['ngStorage', 'ionic', 'pascalprecht.translate', 'ngPDFViewer', 'percentCircle-directive'])

.controller('LogoutCtrl', function($scope, Serv, $state, $http, $ionicLoading, $localStorage) {
    ...
    .controller('loginCtrl', function($scope, $http, $state, $timeout, $stateParams, Serv, $ionicPopup, $timeout, $location, $localStorage, $ionicLoading, $translate) {
        ...
        if (token === null) {
			...
			var userid = $localStorage.userid;
             var link = "https://api.billi.be/mobile/getsession/"+userid+"/"+token;
            $http.get(link).then(function(res) {
...
.controller('ForogotPassCtrl', function($scope, $state, $http, $stateParams, $timeout, $cordovaDevice, $ionicLoading, $ionicPopup, $localStorage, $translate) {
 ...
 $scope.resetpassword = function(email) {
    $ionicLoading.show({
        ...
        var link = 'https://api.billi.be/mobile/resetpassword/';
        $.ajax({
            type: "POST",
            url: link,
            dataType: "json",
...
.controller('SmsConfirmCtrl', function($scope, $state, $http, $stateParams, $cordovaDevice, $ionicLoading, $localStorage, $translate) {
 var phone = $localStorage.phone;
 $scope.curlang = $translate.use($localStorage.lang);
  ...
  document.addEventListener("deviceready", onDeviceReady, false);
        ...
        function onDeviceReady() {
            ...
            $http.post('https://api.billi.be/mobile/pushregister', data, config)
 ...
 $scope.validateme = function(code) {
    $ionicLoading.show({
        ...
        var link = 'https://api.billi.be/mobile/validateme/'+phone+'/'+code;
        $.ajax({
            type: "POST",
            url: link,
            dataType: "json",
...
.controller('OpenTicketCtrl', function($scope, Serv, $location, $http, $ionicLoading, $timeout, $ionicPopup, $localStorage, $translate) {
    $scope.curlang = $translate.use($localStorage.lang);

     $translate(['ticketcreated', 'ticketerror','ticketcreatedid','ticketnotcreated']).then(function(translations) {


    var link = 'https://api.billi.be/mobile/getdept';
    ...
    $scope.submiticket = function(submiticket) {
        ...
        var url = "https://api.billi.be/mobile/submitticket";
        $.ajax({
            type: "POST",
            url: url,
            dataType: "json",
...
.controller('DashCtrl', function($scope, Serv, $state, $localStorage, $ionicLoading, $translate) {
...
.controller('InternetDetailsCtrl', function($scope, $http, $state, $stateParams, $localStorage, Serv, $ionicLoading, $compile, $ionicModal, $translate) {
        $scope.curlang = $translate.use($localStorage.lang);
...
.controller('MobileDetailsCtrl', function($scope, $http, $stateParams, Serv, $localStorage, $ionicLoading, $compile, $ionicModal, $translate) {
    $scope.curlang = $translate.use($localStorage.lang);
...
.controller('MobileCdrCtrl', function($scope, $http, $stateParams, Serv, $ionicLoading, $localStorage, $compile, $ionicModal, $translate) {
        $scope.curlang = $translate.use($localStorage.lang);
        var id = $stateParams.id;
        $scope.data = {};
        $ionicLoading.show({
        ...
        var linkcdr = 'https://api.billi.be/mobile/getcurrentusage/' + id;
    ...
    .controller('TVCtrl', function($scope, $http, $translate, $localStorage) {
        $scope.curlang = $translate.use($localStorage.lang);

        $scope.data = {};
        var link = 'https://api.billi.be/mobile/getservices_t/';
    ...
    .controller('VoipCtrl', function($scope, $http, $translate, $localStorage) {
        $scope.curlang = $translate.use($localStorage.lang);
		 $translate(['number', 'recurring', 'orderdate']).then(function(translations) {

		var userid = $localStorage.userid;
        var voip = 'https://api.billi.be/mobile/getvoip/' + userid;
        $http.get(voip).then(function(v) {
		//console.log(v.data.voipdata);
		if(v.data.hasvoip == true){
		...
		.controller('VoipViewCtrl', function($scope, $http, $translate, $ionicLoading, $stateParams, $localStorage) {
         $scope.curlang = $translate.use($localStorage.lang);
		 $translate(['number', 'recurring', 'orderdate']).then(function(translations) {
        var number = $stateParams.id;
		var userid = $localStorage.userid;
        var voip = 'https://api.billi.be/mobile/getvoipusage/' +number;
    ...
    .controller('ViewTicketCtrl', function($scope, $http, $stateParams, $localStorage, Serv, $ionicModal, $state, $location, $timeout, $ionicPopup, $ionicLoading, $translate) {
        ...
        $translate(['ticketid',
            ...
            $scope.replyticket = function(tick) {
                ...
                var linking2 = 'https://api.billi.be/mobile/replyticket';
                $.ajax({
                    type: "POST",
                    url: linking2,
                    dataType: "json",
...
.controller('TosCtrl', ['$scope', 'PDFViewerService', function($scope, pdf) {
    ...
    .controller('MobileBlockCtrl', function($scope, $state, $ionicLoading, Serv, $ionicPopup, $timeout, $localStorage, $stateParams, $translate) {
        var id = $stateParams.id;
        $scope.curlang = $translate.use($localStorage.lang);
    ...
    .controller('MobileUnBlockCtrl', function($scope, $state, $ionicLoading, Serv, $timeout, $ionicPopup, $localStorage, $stateParams, $translate) {
        var id = $stateParams.id;
        $scope.curlang = $translate.use($localStorage.lang);
        $scope.block = function(reason) {
            $ionicLoading.show({
...
.controller('PendingOrderCtrl', function($scope, $location, $ionicLoading, Serv, $timeout, $ionicPopup, $localStorage, $stateParams, $translate) {
        var userid = $localStorage.userid;
        var token = $localStorage.token;
        $scope.curlang = $translate.use($localStorage.lang);
  ...
  $location.path(path);
        ...
        $translate(['recurring', 'status', 'show_details']).then(function(translations) {
            ...
            var link = 'https://api.billi.be/mobile/getpendingorder';
            $.ajax({
                type: "POST",
                url: link,
                dataType: "json",
...
.controller('PendingViewCtrl', function($scope, $state, $ionicLoading, Serv, $timeout, $ionicPopup, $localStorage, $stateParams, $translate) {
        var id = $stateParams.id;
        $scope.curlang = $translate.use($localStorage.lang);
        $scope.block = function(reason) {
            $ionicLoading.show({
